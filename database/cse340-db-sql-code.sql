...
-- Came from pgAdmin 4-generated script, but not useful for rebuilding the database: ALTER TYPE public.account_type OWNER TO cse340;
--
...
-- Create relationships between `account` and `message` tables
-- Got help from Copilot because I didn't know how to create a foreign key twice in a table
ALTER TABLE public.message DROP CONSTRAINT IF EXISTS fk_message_to;
ALTER TABLE public.message DROP CONSTRAINT IF EXISTS fk_message_from;

ALTER TABLE public.message
	ADD CONSTRAINT fk_message_to FOREIGN KEY (message_to_id)
	REFERENCES public.account (account_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;

ALTER TABLE public.message
	ADD CONSTRAINT fk_message_from FOREIGN KEY (message_from_id)
	REFERENCES public.account (account_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;